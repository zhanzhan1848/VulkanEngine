...
b8 hashtable_should_get_and_set_successfully()
{
    hashtable table;
    u64 element_size = sizeof(u64);
    u64 element_count = 3;
...
b8 hashtable_should_get_and_set_ptr_successfully()
{
    hashtable table;
...
b8 hashtable_should_get_and_set_nonexistant()
{
    hashtable table;
    u64 element_size = sizeof(u64);
    u64 element_count = 3;
...
b8 hashtable_should_get_and_set_ptr_nonexistant()
{
    hashtable table;
    u64 element_size = sizeof(ht_test_struct*);
    u64 element_count = 3;
...
b8 hashtable_should_get_and_unset_ptr()
{
    hashtable table;
    u64 element_size = sizeof(ht_test_struct*);
    u64 element_count = 3;
...
b8 hashtable_try_call_ptr_on_non_ptr_table()
{
    ...
    testval1->f_value = 3.1415f;
    testval1->u_value = 63;
    // Attempt to call pointer function
    b8 result = hashtable_set_ptr(&table, "test1", (void**)&testval1);
    expect_to_be_false(result);
...
{
    test_manager_register_test(hashtable_should_create_and_destroy, "Hashtable shoule create and destroy");
    test_manager_register_test(hashtable_should_get_and_set_successfully, "Hashtable shoule set and get");
    test_manager_register_test(hashtable_should_get_and_set_ptr_successfully, "Hashtable shoule set and get pointer");
    test_manager_register_test(hashtable_should_get_and_set_nonexistant, "Hashtable shoule set and get non-exist entry as nothing");
    test_manager_register_test(hashtable_should_get_and_set_ptr_nonexistant, "Hashtable shoule set and get non-exist pointer entry as nothing");
    test_manager_register_test(hashtable_should_get_and_unset_ptr, "Hashtable shoule set and unset pointer entry as nothing");
    ...
    test_manager_register_test(hashtable_should_set_get_and_update_ptr_successfully, "Hashtable shoule get pointer, update, and get again successfully");
}